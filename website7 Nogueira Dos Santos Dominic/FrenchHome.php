...
<div style="background-color:#e5e5e5;padding:15px;text-align:center;"class="flex-container">
  ...
  <div2>
  <h1><a href="../website7 Nogueira Dos Santos Dominic/Home.php"><img src="Media/England.png" width="150vw"></a></h1>
...
<div style="overflow:auto">
  ...
  <div class="main">
    <h2>Le meilleur marché de la transformation</h2>
    <p>
      Vous ne trouverez ces transformations nulle part ailleurs.</p>
    <h3>Bankais</h3>
